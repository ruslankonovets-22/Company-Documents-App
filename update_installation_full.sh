...
echo "📝 Обновляем installation-full.md с ПОЛНЫМ мануалом..."

cat > docs/installation-full.md << 'EOF'
...
echo "✅ installation-full.md обновлён!"
ls -lh docs/installation-full.md
