...
**Версия:** v0.0.2.4 | **Дата:** 2025-11-22 | **Статус:** 🎉 Production Ready - Fully Tested!
...
- **[v0.0.2](https://github.com/ruslankonovets-22/Company-Documents-App/releases/tag/v0.0.2)** — текущая версия (2025-11-20)
  - 9 DocTypes
  - NextCloud WebDAV sync (473 строки)
  - 5 Server Scripts + 7 Client Scripts
...
- **Код:** 473 строки (nextcloud_sync.py)
- **DocTypes:** 9
- **Server Scripts:** 5
- **Client Scripts:** 7
- **Folder Templates:** 45
