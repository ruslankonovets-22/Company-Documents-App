...
#
# ⚠️  ИЗМЕНЕНИЯ v0.0.2.8:
# - docker build использует интерактивный BuildKit (красивый вывод!)
# - Убран --progress=plain для нативного TTY режима
# - Таймер сборки с отображением времени
#
################################################################################
...
# 🎯 КЛЮЧЕВОЕ ИЗМЕНЕНИЕ: убран --progress=plain
# Теперь Docker BuildKit покажет красивый интерактивный интерфейс!
docker build \
